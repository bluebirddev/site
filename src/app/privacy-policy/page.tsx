            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        to Bluebird Technologies LLC, 701 Tillery Street Unit 12-1899, Austin, Texas
                        78702.
                    </p>
                </li>
                <li>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to Bluebird Technologies, accessible from{' '}
                        <a
                            href="https://bluebird.tech"
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        <a
                            href="https://bluebird.tech/#contact-us"
                            rel="external nofollow noopener"
                            target="_blank"
                        >
                            https://bluebird.tech/#contact-us
                        </a>
                    </p>
                </li>
            </ul>
